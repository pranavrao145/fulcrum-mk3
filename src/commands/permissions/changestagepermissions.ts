...
import {
  stagePermissionsDisable,
  stagePermissionsEnable,
...
const command: ICommand = {
  ...
  execute: async function (interaction: Interaction<CacheType>) {
    ...
    if (channelResolved.type !== ChannelType.GuildStageVoice) {
      throw Error("Cannot alter stage permissions on non-stage channel");
    }
